...
public class Consultations3_Select_Dto {
    ...
    public Consultations3_Select_Dto(ResultSet rs) {
    }

    public Consultations3_Select_Dto(int consultation_id, int doctor_id, int patient_id, LocalDateTime consultation_request_time, LocalDateTime consultation_time, String consultation_status, int consultation_rating) {
